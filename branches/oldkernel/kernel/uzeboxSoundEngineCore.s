...
; (C-call compatible)
; r24 channel (0,1,2)
; r22 patch (0x00-0xfd)=waves, 0xfe=7 bit lfsr, 0xff=15 bit lfsr
;***********************
SetMixerWave:
	clr r25
	clr r23
...
InitSound:
	...
	//clear sound mix buffer
	ldi XL,lo8(mix_buf)
	ldi XH,hi8(mix_buf)

	ldi r24,lo8(MIX_BANK_SIZE*2)
	ldi r25,hi8(MIX_BANK_SIZE*2)
	ldi r16,0
clear_loop:		
	st X+,r16
	sbiw r24,1
	...
	ldi r22,0x1
	sts tr4_barrel_lo,r22
	sts tr4_barrel_hi,r22
	ldi r22,0b00000001  ;15 bits no divider (1)
	sts tr4_params,r22
	...
	sts tr1_step_lo,r22
	sts tr1_step_hi,r22
	sts tr1_pos_frac,r22
	sts tr1_pos_lo,r22

	sts tr2_step_lo,r22
	sts tr2_step_hi,r22
	sts tr2_pos_frac,r22
	sts tr2_pos_lo,r22

	sts tr3_step_lo,r22
	sts tr3_step_hi,r22
	sts tr3_pos_frac,r22
	sts tr3_pos_lo,r22
